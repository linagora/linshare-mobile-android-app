...
object CopyFixtures {
    val COPY_REQUEST_1 = CopyRequest(
        uuid = UUID.fromString("77d10c28-583c-45a8-b747-d8a028f980bb"),
        kind = SpaceType.RECEIVED_SHARE)
    ...
    val COPY_WORKGROUP_DOCUMENT_TO_SHARED_SPACE = CopyRequest(
        uuid = WORK_GROUP_DOCUMENT_1.workGroupNodeId.uuid, kind = SpaceType.SHARED_SPACE
    )
