...
class PickDestinationDialog(
    operatorType: OperatorType,
    selectedDestinationSpaceTypeAction: SelectDestinationSpaceTypeAction<Unit>
) : BasePickDestinationDialog<Unit>(Unit, operatorType, selectedDestinationSpaceTypeAction) {
