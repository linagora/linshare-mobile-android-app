...
class ShareIdParcelable(val uuid: UUID) : Parcelable

fun ShareIdParcelable.toShareId(): ShareId {
    return ShareId(uuid)
}

fun ShareId.toParcelable(): ShareIdParcelable {
    return ShareIdParcelable(uuid)
}
