...
import com.linagora.android.linshare.databinding.DialogRenameDocumentBinding
...
import com.linagora.android.linshare.view.dialog.OnRenameMySpaceDocument
import com.linagora.android.linshare.view.dialog.DaggerBottomSheetDialogFragment

class RenameDocumentDialog(
    private val currentDocumentDialog: Document,
    private val onNegativeCallback: OnNegativeCallback = NoOpCallback,
    private val onRenameMySpaceDocument: OnRenameMySpaceDocument,
    ...
    override fun onCreateView(
        ...
        val binding = DialogRenameDocumentBinding.inflate(inflater, container, false)
            .apply { lifecycleOwner = viewLifecycleOwner }
        initView(binding)
        return binding.root
    }

    private fun initView(binding: DialogRenameDocumentBinding) {
        binding.apply {
            currentDocument = currentDocumentDialog
            state = viewState
            ...
            renameButton.setOnClickListener {
                onRenameMySpaceDocument(currentDocumentDialog, NewNameRequest(newName.text.toString()))
                dismiss() }
