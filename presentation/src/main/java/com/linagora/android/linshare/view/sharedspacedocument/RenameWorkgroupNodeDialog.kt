...
import com.linagora.android.linshare.databinding.DialogRenameWorkgroupNodeBinding
...
import com.linagora.android.linshare.view.dialog.OnRenameSharedSpaceDocument

class RenameWorkgroupNodeDialog(
    private val currentWorkGroupNode: WorkGroupNode,
    private val listWorkGroupNodes: LiveData<List<WorkGroupNode>>,
    private val onNegativeCallback: OnNegativeCallback = NoOpCallback,
    private val onRenameWorkgroupNode: OnRenameSharedSpaceDocument,
    ...
    companion object {
        const val TAG = "rename_workgroup_node"
    }
    ...
    override fun onCreateView(
        ...
        val binding = DialogRenameWorkgroupNodeBinding.inflate(inflater, container, false)
            .apply { lifecycleOwner = viewLifecycleOwner }
        initView(binding)
        return binding.root
    }

    private fun initView(binding: DialogRenameWorkgroupNodeBinding) {
        binding.apply {
            currentNode = currentWorkGroupNode
            listWorkGroupNode = listWorkGroupNodes
            state = viewState
            ...
            renameButton.setOnClickListener {
                onRenameWorkgroupNode(currentWorkGroupNode, NewNameRequest(newName.text.toString()))
                dismiss() }
