...
import com.linagora.android.linshare.databinding.DialogCreateFolderBinding
...
class CreateFolderDialog(
    ...
    private val onCreateSharedSpaceNode: OnPositiveWithEnteredCharactersCallback,
    ...
    override fun onCreateView(
        ...
        val binding = DialogCreateFolderBinding.inflate(inflater, container, false)
        initView(binding)
        return binding.root
    }

    private fun initView(binding: DialogCreateFolderBinding) {
        binding.apply {
            ...
            createButton.setOnClickListener {
                onCreateSharedSpaceNode.invoke(binding.nameFolder.text.toString())
                dismiss()
            }
            state = viewState
