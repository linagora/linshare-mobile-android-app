...
import com.linagora.android.linshare.adapter.role.RolesForUpdateAdapter
...
class SelectRoleForUpdateDialog(
    ...
    private val onSelectRoleForUpdateBehavior: OnSelectRolesForUpdate
) : DaggerBottomSheetDialogFragment() {

    companion object {
        const val TAG = "selectRoleForUpdate"
    }
    ...
    private fun initListRole(): RolesForUpdateAdapter {
        val adapter = RolesForUpdateAdapter(lastSelectedRole, onSelectRoleForUpdateBehavior, sharedSpaceMember)
