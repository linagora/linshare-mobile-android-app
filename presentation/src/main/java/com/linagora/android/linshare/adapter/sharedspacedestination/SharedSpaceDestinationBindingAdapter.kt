...
@BindingAdapter("sharedSpaceDestinationState", "itemBehaviorDestination", "operationRolesDestination", requireAll = true)
fun bindingSharedSpaceDestinationList(
    ...
    sharedSpaceState?.fold(
        ...
        ifRight = { success ->
            ...
            when (success) {
                is SharedSpaceViewState -> (recyclerView.adapter as SharedSpaceAdapter).submitList(success.sharedSpace.filterSharedSpaceDestinationByRole(operationRoles))
            }
        })
}
