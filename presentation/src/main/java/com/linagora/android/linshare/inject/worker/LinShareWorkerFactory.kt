...
class LinShareWorkerFactory @Inject constructor(
    private val workerFactories: @JvmSuppressWildcards Map<Class<out ListenableWorker>, Provider<ChildWorkerFactory>>
) : WorkerFactory() {
