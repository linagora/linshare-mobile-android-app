...
class CreateFolderBehavior(val viewModel: BaseViewModel) : OnSelectedCreateBehavior {
    override fun onCreate(newNameRequest: NewNameRequest) {
        viewModel.dispatchUIState(Either.right(CreateFolderViewEvent(newNameRequest)))
    }
}
