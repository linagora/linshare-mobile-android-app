...
class MySpaceCopyToContextMenu(private val viewModel: BaseViewModel) : CopyToContextMenu<Document> {

    override fun copyTo(item: Document) {
        viewModel.dispatchUIState(Either.right(CopyDocumentToSharedSpaceClick(item)))
    }
}
