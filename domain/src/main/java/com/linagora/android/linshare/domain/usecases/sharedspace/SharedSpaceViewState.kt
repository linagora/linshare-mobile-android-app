...
data class DuplicatedNameError(val duplicateName: NewNameRequest) : Failure.FeatureFailure()
...
data class RenameSharedSpaceItemClick(val sharedSpaceNodeNested: SharedSpaceNodeNested) : Success.OnlineViewEvent(OperatorType.Rename)
