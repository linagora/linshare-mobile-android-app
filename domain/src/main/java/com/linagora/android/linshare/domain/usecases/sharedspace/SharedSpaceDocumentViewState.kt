...
data class SharedSpaceDocumentItemClick(val workGroupDocument: WorkGroupDocument) : Success.OnlineViewEvent(OperatorType.OnItemClick)
data class SharedSpaceFolderItemClick(val workGroupFolder: WorkGroupFolder) : Success.OnlineViewEvent(OperatorType.OnItemClick)
...
data class DuplicateInSharedSpaceFailure(val throwable: Throwable) : Failure.FeatureFailure()
