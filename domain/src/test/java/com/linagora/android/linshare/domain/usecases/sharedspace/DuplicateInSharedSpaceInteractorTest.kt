...
class DuplicateInSharedSpaceInteractorTest {

    @Mock
    lateinit var sharedSpaceDocumentRepository: SharedSpacesDocumentRepository

    private lateinit var duplicateInSharedSpaceInteractor: DuplicateInSharedSpaceInteractor

    @BeforeEach
    fun setUp() {
        MockitoAnnotations.initMocks(this)
        duplicateInSharedSpaceInteractor =
            DuplicateInSharedSpaceInteractor(sharedSpaceDocumentRepository)
    }
    ...
    fun duplicateInSharedSpaceShouldFailedWhenDuplicateThrowException() {
        runBlockingTest {
            ...
            assertThat(duplicateStates).containsExactly(LOADING_STATE, Either.left(DuplicateInSharedSpaceFailure(duplicateException)))
        }
    }
}
