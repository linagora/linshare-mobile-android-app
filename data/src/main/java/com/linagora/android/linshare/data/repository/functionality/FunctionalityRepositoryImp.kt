...
class FunctionalityRepositoryImp @Inject constructor(
    private val functionalityDataSource: FunctionalityDataSource
) : FunctionalityRepository {

    override suspend fun getAll(): List<Functionality> {
        return functionalityDataSource.getAll()
    }
}
