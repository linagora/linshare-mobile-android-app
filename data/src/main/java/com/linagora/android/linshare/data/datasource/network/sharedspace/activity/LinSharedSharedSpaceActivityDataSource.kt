...
package com.linagora.android.linshare.data.datasource.network.sharedspace.activity
...
@Singleton
class LinSharedSharedSpaceActivityDataSource @Inject constructor(
    ...
    override suspend fun getAllActivities(sharedSpaceId: SharedSpaceId): List<AuditLogEntryUser> {
        return linshareApi.findAllWorkGroupActivities(sharedSpaceId.uuid.toString())
    }
}
